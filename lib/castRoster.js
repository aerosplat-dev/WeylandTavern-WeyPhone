 ...
 * }} options
 * @returns {Array<{fullName: string, entryName: string, macroKey: string, hasFullBot: boolean, portraitFirstName: string}>}
 */
export function buildCastRoster({ weybooruCharacters, weylandEntries, charPerKeys, excludedEntryNames = [] }) {
