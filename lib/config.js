import { migrateLegacyConversations, migrateMemoryFields, migrateTetheredFields, migrateParticipantsField, migrateUnreadCountField, migrateNicknameFields, migrateRoleplayChatIdField, migrateConversationNameFields } from './storage.js';
...
export const defaultSettings = Object.freeze({
    ...
    hijackEnabled: false,
    userNicknames: [...BUILT_IN_USER_NICKNAMES],
    characterNicknames: {},
});
