 ...
 * @param {Array<{id: string, participants: string[], lastMessageSnippet: string, lastActive: number}>} summaries
 * @param {Set<string>} generatingConversationIds
 * @returns {Array<{id: string, participants: string[], lastMessageSnippet: string, lastActive: number, isTyping: boolean}>}
 */
