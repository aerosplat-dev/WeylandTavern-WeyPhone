 ...
 * @param {HTMLElement} container #wp-screen-body
 */
export function renderHousingScreen(container) {
    container.innerHTML = `<iframe class="wp-housing-iframe" src="${MAPS_BASE_URL}/weyland_dorms.html" title="Weyland Housing"></iframe>`;
}
