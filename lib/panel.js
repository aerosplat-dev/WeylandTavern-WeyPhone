...
/**
 * @param {HTMLElement} container #wp-screen-body
 * @param {Array<{id: string, participants: string[], lastMessageSnippet: string, lastActive: number, isTyping?: boolean, unreadCount?: number}>} summaries
...
<div class="wp-list-item wp-conversation-item" data-id="${escapeHtml(summary.id)}">
    ...
    <div class="wp-list-item-main">
        <div class="wp-list-item-title">${escapeHtml(displayName)}</div>
