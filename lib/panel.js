 ...
 *   message interrupts the run. When isGroup is false/omitted, rendering is byte-for-byte
 *   unchanged from before this milestone (no name/avatar, matching a solo conversation's existing
 *   always-right-justified-user / always-left-justified-character convention).
 */
