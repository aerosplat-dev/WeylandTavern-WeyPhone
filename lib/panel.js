...
/**
 * @param {HTMLElement} container #wp-screen-body
 * @param {{character: {name: string, handle: string} | undefined, portraitMap: Record<string, {primaryUrl: string|null, fallbackUrl: string|null, initial: string|null}>, entry: {content: {sections: Array<{title: string, items: Array<{text: string, timestamp?: string}>}>}, generatedAt: number} | undefined, isGenerating: boolean, formatRelativeTime: (epochMs: number) => string}} state
 */
