...
/**
 * @param {HTMLElement} container #wp-screen-body
 * @param {{flavorAppsEnabled: boolean, athelEnabled: boolean}} state
 */
export function renderAppGridScreen(container, { flavorAppsEnabled, athelEnabled }) {
    const disabledClass = flavorAppsEnabled ? '' : ' wp-app-tile-disabled';
    const athelDisabledClass = athelEnabled ? '' : ' wp-app-tile-disabled';
    container.innerHTML = `
<div class="wp-app-grid">
    ...
    <div class="wp-app-tile${athelDisabledClass}" data-app="athel">
