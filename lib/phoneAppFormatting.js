...
// Unwraps `**bold**`/`__bold__`/`*italic*`/`_italic_` down to their inner text so no emphasis
// markers ever reach the rendered UI. Applied to both item text and section titles.
const MARKDOWN_EMPHASIS_RE = /(\*\*\*|___|\*\*|__|\*|_)(.+?)\1/g;
