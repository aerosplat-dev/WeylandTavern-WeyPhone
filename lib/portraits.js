 ...
 *
 * The weybooru URL is built directly from `charName` and attempted for EVERY name, regardless of
...
export function buildPortraitMap(characters, charNames, getThumbnailUrl) {
    ...
    for (const charName of new Set(charNames)) {
        ...
        map[charName] = {
            primaryUrl: `${WEYBOORU_PORTRAIT_BASE_URL}/${charName.toLowerCase()}.jpg`,
