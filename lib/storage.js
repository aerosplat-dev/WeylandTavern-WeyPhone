 ...
 * @param {{conversations: Record<string, Conversation>}} settings
 * @param {string} id
 * @param {{memoryThreshold?: number, memoryConnectionProfileId?: string}} [options]
 * @returns {Conversation | undefined}
 */
export function setMemorySettings(settings, id, { memoryThreshold, memoryConnectionProfileId } = {}) {
    const conversation = getConversation(settings, id);
    if (!conversation) return undefined;
