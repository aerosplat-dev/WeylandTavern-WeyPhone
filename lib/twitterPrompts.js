...
import { WEYLAND_ROSTER, TWITTER_ONLY_ROSTER, formatRosterAsText, formatNameHandle } from './weylandRoster.js';
...
back-and-forth. Unlike a closed group chat, this is a public feed written for an audience of
strangers/followers — posts can be broader opinions or self-contained observations that don't
assume the reader knows the poster personally. Avoid writing these like a live group-chat reply
thread, and avoid an anonymous-sounding confession or explicit rant — these are public posts under
...
an ongoing back-and-forth. Unlike a closed group chat, this is a public feed written for an
audience of strangers/followers — posts can be broader opinions or self-contained observations that
don't assume the reader knows the poster personally. Avoid writing these like a live group-chat
reply thread, and avoid an anonymous-sounding confession or explicit rant — these are public posts
under the poster's own name, so keep them a personal broadcast, not a conversation or an anonymous
vent.

## WEYLAND ROSTER (for inspiration — draw from these established personalities)
${formatRosterAsText(WEYLAND_ROSTER)}

## OTHER NOTABLE ACCOUNTS (NOT Weyland students or staff — a visiting figure and a local-but-unaffiliated parent, with no university-student-body presence at all)
${formatRosterAsText(TWITTER_ONLY_ROSTER)}
